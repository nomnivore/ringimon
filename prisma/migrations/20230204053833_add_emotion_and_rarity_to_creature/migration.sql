/*
  ...
  - Added the required column `emotionId` to the `Creature` table without a default value. This is not possible if the table is not empty.
  - Added the required column `rarityId` to the `Creature` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Creature" ("botId", "createdAt", "essenceId", "id", "midId", "topId", "typeGroupId", "typeId", "updatedAt", "userId") SELECT "botId", "createdAt", "essenceId", "id", "midId", "topId", "typeGroupId", "typeId", "updatedAt", "userId" FROM "Creature";
DROP TABLE "Creature";
